...
\begin{document}
\name{Jedrzej Blaszyk}
\tagline{Imperial College London Student}
...
%  \twitter{@marissamayer}
  \linkedin{linkedin.com/in/jedrzej-blaszyk/}
   \github{github.com/jedrazb} % I'm just making this up though.
...
\cvevent{Data Science Intern}{Yelp}{April 2019 -- Sep 2019}{San Francisco, California}
\begin{itemize}
...
\cvevent{Software Engineering Intern}{Yelp}{June 2018 -- October 2018}{Hamburg, Germany}
\begin{itemize}
...
\cvevent{Software Engineer (intern + part-time)}{Seneca Learning}{July 2017 -- Apr 2019}{London, UK}
\begin{itemize}
...
\cvevent{MEng Computing (ML specialisation)}{Imperial College London}{ October 2016 -- June 2020}{}
\begin{itemize}
